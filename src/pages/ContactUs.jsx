...
function ContactUs() {
  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8 lg:py-24">
        <div className="mb-8"><BrandMark /></div>
        <section className="relative overflow-hidden rounded-[2rem] border border-[#CBA65C]/30 bg-[#101B1E] p-8 shadow-[0_24px_80px_rgba(203,166,92,0.12)] sm:p-12 lg:p-16">
          ...
          <div className="relative max-w-3xl">
            ...
            <p className="mt-5 max-w-2xl text-base leading-8 text-[#C3C7BD] sm:text-lg">
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[0.85fr_1.15fr]">
          <aside className="rounded-3xl border border-[#E5E5E5] bg-white p-8 shadow-sm sm:p-10">
            ...
            <div className="mt-8 grid gap-3 border-t border-[#E5E5E5] pt-6 text-sm text-[#666666]">
              <p className="font-semibold text-[#222222]">We can help with</p>
              <p>Content corrections, privacy questions, access guidance, and general feedback.</p>
            </div>
            <a
          ...
          <form onSubmit={handleSubmit} className="rounded-3xl border border-[#E5E5E5] bg-white p-8 shadow-sm sm:p-10">
